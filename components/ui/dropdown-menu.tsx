...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] rounded-xl border border-border bg-popover/90 p-1 text-popover-foreground shadow-2xl shadow-primary/10 backdrop-blur-xl",
      className,
    )}
    {...props}
  />
...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 min-w-[12rem] rounded-2xl border border-border bg-popover/90 p-1 text-popover-foreground shadow-2xl shadow-primary/10 backdrop-blur-xl",
        className,
      )}
      {...props}
    />
